...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    return define('backbone.viewdsl',['jquery', 'backbone', 'underscore'], function(jQuery, Backbone, _) {
...
define("soundmanager2", (function (global) {
    return function () {
        var ret, fn;
...
if ((typeof define !== "undefined" && define !== null ? define.amd : void 0) != null) {
  define('youtubemanager',[],youtubeManager);
}
;
define('songlocator-base',['require','exports','module','xmlhttprequest'],function(require, exports, module) {
// Generated by CoffeeScript 1.4.0
/*
...
define('songlocator-youtube',['require','exports','module','./songlocator-base'],function(require, exports, module) {
// Generated by CoffeeScript 1.4.0
/*
...
var BaseResolver, Resolver, extend, regexIndexOf, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
Resolver = (function(_super) {
  ...
  Resolver.prototype.resolve = function(qid, song, artist, album) {
    var query;
    query = [artist || '', song || ''].join(' ').trim();
    return this.search(qid, query);
  };

  Resolver.prototype.item2result = function(item, query) {
    var parsedTrack, result;
    ...
    if (this.getTrack(item.title, query, true)) {
      ...
      result.score = parsedTrack.isOfficial != null ? 0.85 : 0.95;
